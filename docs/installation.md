...
GoalRouter 1.0.7 installs a small native launcher and keeps the Python application inside
...
The release manifest enforces supported architecture and minimum versions. Version 1.0.7
