...
GoalRouter 1.0.2 installs a small native launcher and keeps the Python application inside
...
The release manifest enforces supported architecture and minimum versions. Version 1.0.2
