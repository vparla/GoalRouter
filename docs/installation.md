...
GoalRouter 1.0.0 installs a small native launcher and keeps the Python application inside
...
The release manifest enforces supported architecture and minimum versions. Version 1.0.0
...
Expand-Archive -Path .\goalrouter-1.0.0-windows.zip -DestinationPath .\goalrouter-1.0.0 -WhatIf
.\install.ps1 -Version 1.0.0 -Yes
```
