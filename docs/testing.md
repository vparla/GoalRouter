...
launcher parity, and failure cases. The scripts declare Windows PowerShell 5.1 support,
but this environment has no native live run of Windows PowerShell 5.1. A clean Windows
release-candidate installation remains a release validation requirement.
